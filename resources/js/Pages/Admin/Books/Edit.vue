...
const form = useForm({
    ...
    doi: props.book.doi || '',
    is_open_access: Boolean(props.book.is_open_access),
    sort_order: props.book.sort_order || 0,
});
    ...
    <AdminLayout>
        <template #header>
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-lg font-bold text-gray-900 truncate max-w-xl">Edit Monograph: {{ book.title }}</h1>
            </div>
        </template>
        ...
        <div class="max-w-4xl mx-auto">
            <form @submit.prevent="submit" class="bg-white rounded-xl border border-gray-200 p-6 md:p-8 shadow-sm space-y-6">
                <div class="border-b border-gray-100 pb-4">
                    <h2 class="text-base font-bold text-gray-900">Update Book Monograph Details</h2>
                </div>
